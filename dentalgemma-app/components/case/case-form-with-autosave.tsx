...
export function CaseFormWithAutosave({ onSubmit, isSubmitting = false }: CaseFormWithAutosaveProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed top-20 right-4 z-50 bg-white rounded-lg shadow-lg px-4 py-2 border">
        <div className="flex items-center gap-2">
          <div className={`w-2 h-2 ${statusDisplay.color} rounded-full ${statusDisplay.animate ? 'animate-pulse' : ''}`} />
